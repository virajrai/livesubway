...
directionDict = {}
directionDict[1]="North"
directionDict[3]="South"
...
def call():
    ...
    for ii in range(len(feed.entity)):
        ...
        if entity.trip_update.trip.HasExtension(nyct.nyct_trip_descriptor):
            if (entity.trip_update.trip.Extensions[nyct.nyct_trip_descriptor].is_assigned):
                print(entity)
                ...
                print "Current stop number:", entity2.vehicle.current_stop_sequence
                print "Current status:", entity2.vehicle.current_status
                ...
                for stop in entity.trip_update.stop_time_update:
                    ...
                    if stop.HasExtension(nyct.nyct_stop_time_update):
                        if hasattr(stop.Extensions[nyct.nyct_stop_time_update],'actual_track'):
                            if (stop.Extensions[nyct.nyct_stop_time_update].actual_track) !='':
                                print(entity)
                                if(i==2):
                                    done = True
                                break;
                                haha = stop
                if haha!=None:
                    if (haha.Extensions[nyct.nyct_stop_time_update].actual_track == '1'):
                        print(haha)
                        print(directionDict[entity.trip_update.trip.Extensions[nyct.nyct_trip_descriptor].direction])
                        """
